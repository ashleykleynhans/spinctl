...
func NewHomePage(cfg *config.SpinctlConfig) *HomePage {
	...
	items := []menuItem{
		...
		{label: "Artifacts", description: "Artifact sources", action: PageArtifacts},
		{label: "Persistent Storage", description: "Storage backends", action: PagePersistentStorage},
		{label: "Notifications", description: "Notification channels", action: PageNotifications},
		{label: "CI", description: "CI integrations", action: PageCI},
		{label: "Repository", description: "Artifact repositories", action: PageRepository},
		{label: "Pub/Sub", description: "Pub/Sub integrations", action: PagePubsub},
		{label: "Canary", description: "Canary analysis", action: PageCanary},
		{label: "Webhook", description: "Webhook configuration", action: PageWebhook},
		{label: "Metric Stores", description: "Metrics backends", action: PageMetricStores},
		{label: "Deployment Environment", description: "Deployment settings", action: PageDeploymentEnv},
